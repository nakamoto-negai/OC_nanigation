...
func Connect() error {
	...
	if err := db.AutoMigrate(&models.Category{}, &models.Node{}, &models.Destination{}, &models.Link{}, &models.Photo{}, &models.NodePhoto{}, &models.Setting{}, &models.MapImage{}, &models.User{}, &models.UserLog{}, &models.NodeDetour{}, &models.ARObject{}, &models.ARFeature{}, &models.SurveyQuestion{}, &models.SurveyResponse{}, &models.SurveyAnswer{}, &models.Event{}, &models.DemoOverlay{}, &models.Announcement{}); err != nil {
