...
func Connect() error {
	...
	if err := db.AutoMigrate(&models.Category{}, &models.Node{}, &models.Link{}, &models.Photo{}, &models.Setting{}, &models.MapImage{}, &models.User{}, &models.UserLog{}, &models.NodeDetour{}); err != nil {
